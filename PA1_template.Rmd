...
#http://stackoverflow.com/questions/21713234/plotting-two-graphs-over-each-other-in-ggplot

##, aes(steps, fill = steps)
...
ggplot(graphData, aes(steps, fill = set)) + geom_histogram(alpha = 0.4, position = "identity")
```
